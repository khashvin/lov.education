    ...
    <section id="main-form" className="main-form py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mx-auto mb-16">
          <span className="bg-[#001e57]/10 text-[#001e57] px-4 py-2 rounded-full text-sm font-semibold inline-block mb-4">
            START YOUR JOURNEY
          </span>
          <h2 className="text-3xl md:text-4xl font-bold text-[#001e57] mb-4">
        ...
        <div className="mx-auto">
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div className="grid md:grid-cols-5">
              ...
              <div className="md:col-span-3 p-8 lg:p-10">
                <h3 className="text-2xl font-bold text-[#001e57] mb-6">
                      ...
                      <div className="flex gap-4 items-center">
                        ...
                        <div>
                          ...
                          <a
                            ...
                            className="text-white hover:text-[#89c540] transition-colors text-lg font-bold"
                          >
                            +6012 - 420 9899
                          </a>
                        </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-500">
              ...
              <a
                href="#"
                className="text-[#001e57] hover:text-[#89c540] underline"
              >
                privacy policy
              </a>{' '}
