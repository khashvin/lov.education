...
export function UniversityListSection({ universities, isLoading, isError }: UniversityListSectionProps) {
      ...
      <section className="py-8 sm:py-12 lg:py-20">
        <div className="container px-4 mx-auto py-4">
          <div className="text-center">
            ...
            <h2 className="text-xl sm:text-2xl font-bold mb-2">Error Loading Universities</h2>
            <p className="text-gray-600 mb-4 sm:mb-6">There was a problem loading the university data. Please try again later.</p>
  ...
  return (
    <section className="py-8 sm:py-12 lg:py-20 overflow-hidden w-full">
      <div className="container px-4 mx-auto py-4">
        <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center">Our Partner Universities in Malaysia</h2>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8 sm:py-12">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">No universities found</h3>
