      ...
      <Card className="group overflow-hidden transition-all duration-300 hover:shadow-lg w-full max-w-full">
        <div className="relative overflow-hidden aspect-[3/2] sm:aspect-[16/9]">
          <div className="absolute inset-0 bg-gray-200 flex items-center justify-center">
            <img src={university.thumbnail} alt={university.name} className="w-full h-full object-cover" />
          </div>
        </div>
        ...
        <CardContent className="p-4 sm:p-6 pt-0 sm:pt-0">
          <p className="text-gray-700 text-sm sm:text-base mb-3 sm:mb-4 line-clamp-3">{university.description}</p>
