    ...
    <section className="about-section-two">
      <div className="auto-container">
        <div className="title-style-one style-two centered">
          <div className="icon"><img src="/images/logo.png" alt="" style={{height: 200}} />
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="content-column col-lg-6 col-md-12 col-sm-12">
            <div className="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
              ...
              <div className="fact-counter wow fadeInRightBig" data-wow-delay="0ms" data-wow-duration="1500ms">
